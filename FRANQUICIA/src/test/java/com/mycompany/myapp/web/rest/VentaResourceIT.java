...
class VentaResourceIT {
    ...
    public static Venta createEntity(EntityManager em) {
        Venta venta = new Venta().fecha(DEFAULT_FECHA).precio(DEFAULT_PRECIO);
        return venta;
    }
    ...
    public static Venta createUpdatedEntity(EntityManager em) {
        Venta venta = new Venta().fecha(UPDATED_FECHA).precio(UPDATED_PRECIO);
        return venta;
    }
    ...
    void putExistingVenta() throws Exception {
        ...
        updatedVenta.fecha(UPDATED_FECHA).precio(UPDATED_PRECIO);
    ...
    void fullUpdateVentaWithPatch() throws Exception {
        ...
        partialUpdatedVenta.fecha(UPDATED_FECHA).precio(UPDATED_PRECIO);
