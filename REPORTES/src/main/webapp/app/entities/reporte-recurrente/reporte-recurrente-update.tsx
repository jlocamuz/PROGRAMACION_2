  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="reportesApp.reporteRecurrente.home.createOrEditLabel" data-cy="ReporteRecurrenteCreateUpdateHeading">
            <Translate contentKey="reportesApp.reporteRecurrente.home.createOrEditLabel">Create or edit a ReporteRecurrente</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('reportesApp.reporteRecurrente.accion')}
              ...
              />
              <ValidatedField
                label={translate('reportesApp.reporteRecurrente.franquiciaUUID')}
              ...
              />
              <ValidatedField
                label={translate('reportesApp.reporteRecurrente.tipo')}
              ...
              />
              <ValidatedField
                label={translate('reportesApp.reporteRecurrente.fechaInicio')}
              ...
              />
              <ValidatedField
                label={translate('reportesApp.reporteRecurrente.fechaFin')}
              ...
              />
              <ValidatedField
                label={translate('reportesApp.reporteRecurrente.intervalo')}
