...
export const ReporteRecurrenteDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="reportesApp.reporteRecurrente.delete.question">
        <Translate contentKey="reportesApp.reporteRecurrente.delete.question" interpolate={{ id: reporteRecurrenteEntity.id }}>
