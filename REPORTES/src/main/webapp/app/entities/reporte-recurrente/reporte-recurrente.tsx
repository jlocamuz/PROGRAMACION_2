  ...
  return (
    <div>
      <h2 id="reporte-recurrente-heading" data-cy="ReporteRecurrenteHeading">
        <Translate contentKey="reportesApp.reporteRecurrente.home.title">Reporte Recurrentes</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="reportesApp.reporteRecurrente.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link
          ...
          >
            ...
            &nbsp;
            <Translate contentKey="reportesApp.reporteRecurrente.home.createLabel">Create new Reporte Recurrente</Translate>
          </Link>
        </div>
      </h2>
        ...
        {reporteRecurrenteList && reporteRecurrenteList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="reportesApp.reporteRecurrente.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="reportesApp.reporteRecurrente.accion">Accion</Translate>
                </th>
                <th>
                  <Translate contentKey="reportesApp.reporteRecurrente.franquiciaUUID">Franquicia UUID</Translate>
                </th>
                <th>
                  <Translate contentKey="reportesApp.reporteRecurrente.tipo">Tipo</Translate>
                </th>
                <th>
                  <Translate contentKey="reportesApp.reporteRecurrente.fechaInicio">Fecha Inicio</Translate>
                </th>
                <th>
                  <Translate contentKey="reportesApp.reporteRecurrente.fechaFin">Fecha Fin</Translate>
                </th>
                <th>
                  <Translate contentKey="reportesApp.reporteRecurrente.intervalo">Intervalo</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="reportesApp.reporteRecurrente.home.notFound">No Reporte Recurrentes found</Translate>
            </div>
          )
        )}
      </div>
