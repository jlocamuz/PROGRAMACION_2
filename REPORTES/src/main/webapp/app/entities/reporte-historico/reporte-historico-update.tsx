  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="reportesApp.reporteHistorico.home.createOrEditLabel" data-cy="ReporteHistoricoCreateUpdateHeading">
            <Translate contentKey="reportesApp.reporteHistorico.home.createOrEditLabel">Create or edit a ReporteHistorico</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('reportesApp.reporteHistorico.accion')}
              ...
              />
              <ValidatedField
                label={translate('reportesApp.reporteHistorico.franquiciaUUID')}
              ...
              />
              <ValidatedField
                label={translate('reportesApp.reporteHistorico.tipo')}
              ...
              />
              <ValidatedField
                label={translate('reportesApp.reporteHistorico.fechaInicio')}
              ...
              />
              <ValidatedField
                label={translate('reportesApp.reporteHistorico.fechaFin')}
