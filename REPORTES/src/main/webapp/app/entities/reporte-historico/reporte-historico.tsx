  ...
  return (
    <div>
      <h2 id="reporte-historico-heading" data-cy="ReporteHistoricoHeading">
        <Translate contentKey="reportesApp.reporteHistorico.home.title">Reporte Historicos</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="reportesApp.reporteHistorico.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/reporte-historico/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            ...
            &nbsp;
            <Translate contentKey="reportesApp.reporteHistorico.home.createLabel">Create new Reporte Historico</Translate>
          </Link>
        </div>
      </h2>
        ...
        {reporteHistoricoList && reporteHistoricoList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="reportesApp.reporteHistorico.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="reportesApp.reporteHistorico.accion">Accion</Translate>
                </th>
                <th>
                  <Translate contentKey="reportesApp.reporteHistorico.franquiciaUUID">Franquicia UUID</Translate>
                </th>
                <th>
                  <Translate contentKey="reportesApp.reporteHistorico.tipo">Tipo</Translate>
                </th>
                <th>
                  <Translate contentKey="reportesApp.reporteHistorico.fechaInicio">Fecha Inicio</Translate>
                </th>
                <th>
                  <Translate contentKey="reportesApp.reporteHistorico.fechaFin">Fecha Fin</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="reportesApp.reporteHistorico.home.notFound">No Reporte Historicos found</Translate>
            </div>
          )
        )}
      </div>
