  ...
  return (
    <div>
      <h2 id="venta-heading" data-cy="VentaHeading">
        <Translate contentKey="reportesApp.venta.home.title">Ventas</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="reportesApp.venta.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/venta/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="reportesApp.venta.home.createLabel">Create new Venta</Translate>
          </Link>
        </div>
      </h2>
        ...
        {ventaList && ventaList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="reportesApp.venta.id">Id</Translate>
                </th>
                <th>
                  <Translate contentKey="reportesApp.venta.fecha">Fecha</Translate>
                </th>
                <th>
                  <Translate contentKey="reportesApp.venta.precio">Precio</Translate>
                </th>
                <th>
                  <Translate contentKey="reportesApp.venta.menu">Menu</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="reportesApp.venta.home.notFound">No Ventas found</Translate>
            </div>
          )
        )}
      </div>
