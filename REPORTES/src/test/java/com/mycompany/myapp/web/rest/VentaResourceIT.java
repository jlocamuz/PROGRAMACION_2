...
class VentaResourceIT {
    ...
    public static Venta createEntity(EntityManager em) {
        Venta venta = new Venta().fecha(DEFAULT_FECHA).precio(DEFAULT_PRECIO).menu(DEFAULT_MENU);
        return venta;
    }
    ...
    public static Venta createUpdatedEntity(EntityManager em) {
        Venta venta = new Venta().fecha(UPDATED_FECHA).precio(UPDATED_PRECIO).menu(UPDATED_MENU);
        return venta;
    }
    ...
    void getAllVentas() throws Exception {
        ...
        restVentaMockMvc
            ...
            .andExpect(jsonPath("$.[*].id").value(hasItem(venta.getId())))
    ...
    void putExistingVenta() throws Exception {
        ...
        updatedVenta.fecha(UPDATED_FECHA).precio(UPDATED_PRECIO).menu(UPDATED_MENU);
    ...
    void fullUpdateVentaWithPatch() throws Exception {
        ...
        partialUpdatedVenta.fecha(UPDATED_FECHA).precio(UPDATED_PRECIO).menu(UPDATED_MENU);
