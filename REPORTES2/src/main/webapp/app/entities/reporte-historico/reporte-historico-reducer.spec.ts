...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './reporte-historico.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REPORTEHISTORICO_LIST actions', async () => {
    ...
    it('dispatches FETCH_REPORTEHISTORICO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REPORTEHISTORICO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REPORTEHISTORICO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REPORTEHISTORICO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REPORTEHISTORICO actions', async () => {
      const expectedActions = [
        {
