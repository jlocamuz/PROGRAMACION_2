...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './reporte-recurrente.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REPORTERECURRENTE_LIST actions', async () => {
    ...
    it('dispatches FETCH_REPORTERECURRENTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REPORTERECURRENTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REPORTERECURRENTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REPORTERECURRENTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REPORTERECURRENTE actions', async () => {
      const expectedActions = [
        {
